...
using LearningLanguageBot.Infrastructure.DeepSeek;
using LearningLanguageBot.Infrastructure.Jobs;
...
try
{
    ...
    builder.Services.AddScoped<ITranslationService, DeepSeekTranslationService>();
